...
class modelicaListener(ParseTreeListener):
    ...
    def enterEnumeration_literal(
            self, ctx: modelicaParser.Enumeration_literalContext):
        pass
    ...
    def enterLanguage_specification(
            self, ctx: modelicaParser.Language_specificationContext):
        pass

    # Exit a parse tree produced by modelicaParser#language_specification.
    def exitLanguage_specification(
            self, ctx: modelicaParser.Language_specificationContext):
        pass

    # Enter a parse tree produced by modelicaParser#external_function_call.
    def enterExternal_function_call(
            self, ctx: modelicaParser.External_function_callContext):
        pass

    # Exit a parse tree produced by modelicaParser#external_function_call.
    def exitExternal_function_call(
            self, ctx: modelicaParser.External_function_callContext):
        pass
    ...
    def enterConstraining_clause(
            self, ctx: modelicaParser.Constraining_clauseContext):
        pass

    # Exit a parse tree produced by modelicaParser#constraining_clause.
    def exitConstraining_clause(
            self, ctx: modelicaParser.Constraining_clauseContext):
        pass

    # Enter a parse tree produced by modelicaParser#component_clause.
    def enterComponent_clause(
            self,
            ctx: modelicaParser.Component_clauseContext):
        pass
    ...
    def enterComponent_declaration(
            self, ctx: modelicaParser.Component_declarationContext):
        pass
    ...
    def enterCondition_attribute(
            self, ctx: modelicaParser.Condition_attributeContext):
        pass

    # Exit a parse tree produced by modelicaParser#condition_attribute.
    def exitCondition_attribute(
            self, ctx: modelicaParser.Condition_attributeContext):
        pass
    ...
    def enterClass_modification(
            self, ctx: modelicaParser.Class_modificationContext):
        pass

    # Exit a parse tree produced by modelicaParser#class_modification.
    def exitClass_modification(
            self, ctx: modelicaParser.Class_modificationContext):
        pass
    ...
    # modelicaParser#element_modification_or_replaceable.
    ...
    def exitSimple_expression(
            self,
            ctx: modelicaParser.Simple_expressionContext):
        pass

    # Enter a parse tree produced by modelicaParser#logical_expression.
    def enterLogical_expression(
            self, ctx: modelicaParser.Logical_expressionContext):
        pass

    # Exit a parse tree produced by modelicaParser#logical_expression.
    def exitLogical_expression(
            self, ctx: modelicaParser.Logical_expressionContext):
        pass
    ...
    def enterArithmetic_expression(
            self, ctx: modelicaParser.Arithmetic_expressionContext):
        pass

    # Exit a parse tree produced by modelicaParser#arithmetic_expression.
    def exitArithmetic_expression(
            self, ctx: modelicaParser.Arithmetic_expressionContext):
        pass
    ...
    def enterFunction_argument(
            self, ctx: modelicaParser.Function_argumentContext):
        pass

    # Exit a parse tree produced by modelicaParser#function_argument.
    def exitFunction_argument(
            self,
            ctx: modelicaParser.Function_argumentContext):
        pass

    # Enter a parse tree produced by modelicaParser#output_expression_list.
    def enterOutput_expression_list(
            self, ctx: modelicaParser.Output_expression_listContext):
        pass

    # Exit a parse tree produced by modelicaParser#output_expression_list.
    def exitOutput_expression_list(
            self, ctx: modelicaParser.Output_expression_listContext):
        pass
    ...
    def enterArray_subscripts(
            self,
            ctx: modelicaParser.Array_subscriptsContext):
        pass

    # Exit a parse tree produced by modelicaParser#array_subscripts.
    def exitArray_subscripts(
            self,
            ctx: modelicaParser.Array_subscriptsContext):
        pass

...
model Storage
  ...
  Buildings.ThermalZones.ReducedOrder.SolarGain.CorrectionGDoublePane corGDoublePane(n=4,  UWin=1.8936557576825388)
    "Correction factor for solar transmission"
    annotation (Placement(transformation(extent={{6,54},{26,74}})));
  Buildings.ThermalZones.ReducedOrder.RC.FourElements
  thermalZoneFourElements(
    redeclare package Medium = Buildings.Media.Air,
    VAir=6420.850657200001,
    hConExt=2.7,
    hConWin=2.7,
    gWin=0.67,
    ratioWinConRad=0.03,
    nExt=1,
    RExt={9.30986457630446e-05},
    CExt={123272741.4981963},
    hRad=4.999999999999999,
    AInt=4161.662463000001,
    hConInt=2.471428571428571,
    nInt=1,
    RInt={1.8701408240708114e-05},
    CInt={407243619.07755315},
    RWin=0.0036645650195461206,
    RExtRem=0.006158717139897813,
    AFloor=273.48067614000007,
    hConFloor=1.7000000000000002,
    nFloor=1,
    RFloor={8.45713417371581e-05},
    RFloorRem=0.005783345643887069,
    CFloor={22001320.56210794},
    ARoof=273.48067614000007,
    hConRoof=1.7000000000000002,
    nRoof=1,
    RRoof={8.698269705976168e-05},
    RRoofRem=0.007059545832937509,
    CRoof={100056484.14431201},
    ...
    nOrientations=4,
    AWin={44.728617934666985, 4.146071600551982, 4.146071600551982, 44.728617934666985},
    ATransparent={44.728617934666985, 4.146071600551982, 4.146071600551982, 44.728617934666985},
    AExt={134.185853804001, 12.438214801655947, 12.438214801655947, 134.185853804001}, nPorts=nPorts, use_moisture_balance=use_moisture_balance)
    "Thermal zone"
  ...
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    ...
    wfWin={0.4575846758314, 0.04241532416859994, 0.04241532416859994, 0.4575846758314},
    withLongwave=true,
    aExt=0.5,
    hConWallOut=20.0,
    hRad=4.999999999999999,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.0*293.24813721131386)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant hConvWin(k=25.000000000000004*97.74937907043793)
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=6837.0169035000035)

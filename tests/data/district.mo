...
model district
  ...
  extends Buildings.Experimental.DHC.Examples.Combined.BaseClasses.PartialSeries(
      redeclare Buildings.Experimental.DHC.Loads.Combined.BuildingTimeSeriesWithETS bui[nBui](final filNam=filNam),
      datDes(
        nBui=8,
        mPumDis_flow_nominal=1029.114,
        mPipDis_flow_nominal=1029.114,
        mPla_flow_nominal=1029.114,
        dp_length_nominal=250,
        epsPla=0.935
      )
  );
  parameter String filNam[nBui]={
    "modelica://baseline/Resources/Data/Districts/1/modelica.mos",
    "modelica://baseline/Resources/Data/Districts/2/modelica.mos",
    "modelica://baseline/Resources/Data/Districts/3/modelica.mos",
    "modelica://baseline/Resources/Data/Districts/4/modelica.mos",
    "modelica://baseline/Resources/Data/Districts/5/modelica.mos",
    "modelica://baseline/Resources/Data/Districts/6/modelica.mos",
    "modelica://baseline/Resources/Data/Districts/7/modelica.mos",
    "modelica://baseline/Resources/Data/Districts/8/modelica.mos"
    }

...
model Office
  ...
  IDEAS.Buildings.Components.Window MMM_Fixed_3000_x_2000mm_3__WinRoom0BoQ(
    A=9.52,
    inc=1.5707963267948966,
    azi=0.0,
    frac=1-0.9,
    redeclare IDEAS.Buildings.Components.Shading.None shaType,
    redeclare Model.Data.Glazing.MM_Fixed_3000_x_2000mm_3_ glazing,
  ...
  Modelica.Blocks.Sources.Constant hConvWin(
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://teaser_rc_default/Loads/Resources/Data/B5a6b99ec37f4de7f94020090/InternalGains_Office.txt"),
    columns={2,3,4})
  ...
  Modelica.Fluid.Vessels.BaseClasses.VesselFluidPorts_b ports[nPorts](
    ...
    annotation (Placement(transformation(extent={{-30,-8},{30,8}},origin={0,-100}),iconTransformation(extent={{-23.25,-7.25},{23.25,7.25}},origin={-0.75,-98.75})));
  Modelica.Thermal.HeatTransfer.Interfaces.HeatPort_a port_b
    "Heat port for radiative heat flow."
    annotation (Placement(transformation(extent={{30,-110},{50,-90}},iconTransformation(extent={{40,-112},{60,-92}}))));
...
equation
  ...
  connect(weaBus,HDifTil[1].weaBus)
    annotation (Line(points={{-78,62},{-74,62},{-74,30},{-68,30}},color={255,204,51},thickness=0.5));
  connect(weaBus,HDirTil[1].weaBus)
    annotation (Line(points={{-78,62},{-73,62},{-68,62}},color={255,204,51},thickness=0.5));
  ...
  connect(personsRad.port,thermalZoneTwoElements.intGainsRad)
    annotation (Line(points={{68,-32},{84,-32},{100,-32},{100,24},{92.2,24}},color={191,0,0}));
  connect(thermalConductorWin.solid,thermalZoneTwoElements.window)
    annotation (Line(points={{38,21},{40,21},{40,20},{43.8,20}},color={191,0,0}));
  ...
  connect(thermalZoneTwoElements.ports,ports)
    annotation (Line(points={{83,-1.95},{83,-84},{0,-84},{0,-100}},color={0,127,255}));
  connect(thermalZoneTwoElements.intGainsRad,port_b)
    annotation (Line(points={{92,24},{98,24},{98,-100},{40,-100}},color={191,0,0}));
  connect(thermalZoneTwoElements.QLat_flow,perLatLoa.y)
    annotation (Line(points={{43,4},{40,4},{40,-28},{-40,-28},{-40,-50},{-59,-50}},color={0,0,127}));
  connect(thermalZoneTwoElements.TRad,TRad)
    annotation (Line(points={{93,28},{98,28},{98,-20},{110,-20}},color={0,0,127}));
  connect(thermalZoneTwoElements.TAir,TAir)
    annotation (Line(points={{93,32},{98,32},{98,48},{110,48}},color={0,0,127}));

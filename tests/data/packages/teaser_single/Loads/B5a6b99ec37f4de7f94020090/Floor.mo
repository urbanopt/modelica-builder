...
model Floor
  ...
  Buildings.ThermalZones.ReducedOrder.SolarGain.CorrectionGDoublePane corGDoublePane(n=4,  UWin=1.8936557576825381)
    "Correction factor for solar transmission"
    annotation (Placement(transformation(extent={{6,54},{26,74}})));
  Buildings.ThermalZones.ReducedOrder.RC.FourElements
  thermalZoneFourElements(
    redeclare package Medium = Buildings.Media.Air,
    VAir=10701.417762000001,
    hConExt=2.7000000000000006,
    hConWin=2.7000000000000006,
    gWin=0.6699999999999999,
    ratioWinConRad=0.029999999999999995,
    nExt=1,
    RExt={5.585918745782677e-05},
    CExt={205454569.16366053},
    hRad=5.0,
    AInt=13178.597799500001,
    hConInt=2.5796992481203014,
    nInt=1,
    RInt={7.168509129855457e-06},
    CInt={1039226572.0160846},
    RWin=0.002198739011727672,
    RExtRem=0.0036952302839386884,
    AFloor=455.8011269000001,
    hConFloor=1.7000000000000002,
    nFloor=1,
    RFloor={5.074280504229486e-05},
    RFloorRem=0.003470007386332242,
    CFloor={36668867.60351304},
    ARoof=455.8011269000001,
    hConRoof=1.7000000000000002,
    nRoof=1,
    RRoof={5.218961823585701e-05},
    RRoofRem=0.004235727499762506,
    CRoof={166760806.9071867},
    ...
    nOrientations=4,
    AWin={74.54769655777831, 6.910119334253305, 6.910119334253305, 74.54769655777831},
    ATransparent={74.54769655777831, 6.910119334253305, 6.910119334253305, 74.54769655777831},
    AExt={223.64308967333497, 20.730358002759914, 20.730358002759914, 223.64308967333497}, nPorts=nPorts, use_moisture_balance=use_moisture_balance)
    "Thermal zone"
  ...
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    ...
    wfWin={0.4575846758314001, 0.04241532416859994, 0.04241532416859994, 0.4575846758314001},
    withLongwave=true,
    aExt=0.5,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.0*488.74689535218977)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant hConvWin(k=25.0*162.91563178406324)
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=11395.028172500002)

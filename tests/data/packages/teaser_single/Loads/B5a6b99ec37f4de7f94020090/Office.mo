...
model Office
  ...
  thermalZoneFourElements(
    ...
    nExt=1,
    RExt={2.7929593728913385e-05},
    CExt={410909138.32732105},
    hRad=5.0,
    AInt=13872.20821,
    hConInt=2.4714285714285715,
    nInt=1,
    RInt={5.610422472212433e-06},
    CInt={1357478730.2585104},
    RWin=0.001099369505863836,
    RExtRem=0.0018476151419693442,
    AFloor=911.6022538000002,
    hConFloor=1.7000000000000002,
    nFloor=1,
    RFloor={2.537140252114743e-05},
    RFloorRem=0.001735003693166121,
    CFloor={73337735.20702608},
    ARoof=911.6022538000002,
    hConRoof=1.7000000000000002,
    nRoof=1,
    RRoof={2.6094809117928505e-05},
    RRoofRem=0.002117863749881253,
    CRoof={333521613.8143734},
    ...
    nOrientations=4,
    AWin={149.09539311555662, 13.82023866850661, 13.82023866850661, 149.09539311555662},
    ATransparent={149.09539311555662, 13.82023866850661, 13.82023866850661, 149.09539311555662},
    AExt={447.28617934666994, 41.46071600551983, 41.46071600551983, 447.28617934666994}, nPorts=nPorts, use_moisture_balance=use_moisture_balance)
    "Thermal zone"
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.0*977.4937907043795)
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=22790.056345000005)
